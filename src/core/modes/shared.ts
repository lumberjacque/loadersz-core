import { addArc, addDot, addLine, addPolygon, addRect, createFrame, depth } from '../frame';
...
export { addArc, addDot, addLine, addPolygon, addRect, createFrame, depth, fibonacciPoint, hash, lerp, normalize, smoothstep, TAU };
